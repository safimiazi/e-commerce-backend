...
exports.carouselService = {
    ...
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield carousel_model_1.carouselModel.findById(id);
            }
            catch (error) {
                if (error instanceof Error) {
                    throw new Error(`${error.message}`);
    ...
    update(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const isDeleted = yield carousel_model_1.carouselModel.findOne({ _id: data.id });
                if (!isDeleted) {
                    throw new AppError_1.default(http_status_1.default.NOT_FOUND, "carousel is already deleted");
                }
                const result = yield carousel_model_1.carouselModel.updateOne({ _id: data.id }, data, {
                    new: true,
                });
                if (!result) {
    ...
    bulkDelete(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existingcarousel = yield carousel_model_1.carouselModel.find({ _id: { $in: ids } });
                if (existingcarousel.length === 0) {
                    throw new AppError_1.default(http_status_1.default.NOT_FOUND, "No carousel found with the given IDs");
                }
                // Step 2: Perform soft delete by updating isDelete field to true
                yield carousel_model_1.carouselModel.updateMany({ _id: { $in: ids } }, { isDelete: true });
                return;
            }
            catch (error) {
                if (error instanceof Error) {
